<svg class="w-full sm:h-64 mx-auto" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
  ...
  <path
    ...
    fill="#f2f2f2"
  />
  <ellipse cx="588.5" cy="577.5" rx="588.5" ry="21" fill="#ABD2FA" />
  <path
    transform="translate(-11.5 -150.75)"
  ...
  <path d="m172 133.75h268v434h-247.58a20.42 20.42 0 0 1 -20.42 -20.42v-413.58z" fill="#091540" />
  <path transform="translate(-11.5 -150.75)" d="M1017,282.42V294H183V282.42A20.42,20.42,0,0,1,203.42,262H996.58A20.42,20.42,0,0,1,1017,282.42Z" fill="#ABD2FA" />
  <circle cx="193" cy="127.75" r="6" fill="#091540" />
  <circle cx="208" cy="127.75" r="6" fill="#091540" />
  <circle cx="223" cy="127.75" r="6" fill="#091540" />
  ...
  <path
    ...
    fill="#ABD2FA"
  />
  <rect x="604" y="260.14" width="347" height="11" rx="1.24" fill="#091540" opacity=".3" />
  <rect x="604" y="392.07" width="347" height="11" rx="1.24" fill="#091540" opacity=".3" />
  <rect x="878" y="279.75" width="73" height="25" rx="1.24" fill="#091540" />
  <rect x="878" y="411.75" width="73" height="25" rx="1.24" fill="#091540" />
  <path transform="translate(-11.5 -150.75)" d="m978.18 606.93l-1.73 2s-21.05 2-20.2 5.39 25.35-4.55 25.35-4.55z" fill="#ffc1c7" />
  <path transform="translate(-11.5 -150.75)" d="m1016.3 605.22s-22.5 8-34.74 4.56l5.69 11.39s29.05-0.86 34.18-6-5.13-9.95-5.13-9.95z" fill="#7692FF" />
  ...
  <path transform="translate(-11.5 -150.75)" d="m990.71 553.1s20.5-12.81 37.59 0 28.48 71.2 28.48 71.2l-39.59-8.83s-1.7-6.83-4-8-2.57-6-2.57-6-12.24-3.7-11.39-17.94-8.52-30.43-8.52-30.43z" fill="#7692FF" />
  <path transform="translate(-11.5 -150.75)" d="m1001.2 553.67h-10.54s-6.27 7.12-7.12 25.06l-3.42 14.27s-7.12 17.09-2.85 19.94 12.54 2.56 14.24-3.13 13.44-38.76 13.44-38.76z" fill="#7692FF" />
  <path
    transform="translate(-11.5 -150.75)"
